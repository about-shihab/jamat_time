          ...
          children: [
            ...
            Row(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.people_alt_outlined, size: 18, color: Theme.of(context).hintColor),
                ...
                ElevatedButton.icon(
                  ...
                  icon: Icon(
                    widget.event.isUserGoing ? Icons.check_circle : Icons.add_circle_outline,
                    size: 20,
                  ),
                  label: Text(widget.event.isUserGoing ? "You're Going" : 'I am Going'),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: widget.event.isUserGoing ? AppTheme.accentGold : AppTheme.accentColor,
